window.site_logo = theme_info.theme_dir+"/images/viradeco-logo.png";
console.log(site_logo);
window.loading_screen = window.pleaseWait({

		        //logo: theme_info.theme_dir+"/images/viradeco-logo.png",
		        //console.log(site_logo);
		        logo:site_logo,

		        logo: "wp-content/themes/viradeco.com/images/viradeco-logo.png",
